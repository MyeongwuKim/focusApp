...
type SettingsThemeViewProps = {
  onBack: () => void;
};

export function SettingsThemeView({ onBack }: SettingsThemeViewProps) {
  ...
  return (
    <SettingsDetailShell title="테마" description="스타일과 모드를 선택하세요." onBack={onBack}>
