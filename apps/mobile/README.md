...
EXPO_PUBLIC_WEBUI_MANIFEST_URL_DEV=
EXPO_PUBLIC_WEBUI_MANIFEST_URL_PROD=
```
...
- `EXPO_PUBLIC_WEBUI_CHANNEL`: 웹UI 채널 선택값 (`dev` 또는 `prod`)
- `EXPO_PUBLIC_WEBUI_MANIFEST_URL_DEV`: 개발 채널 최신 manifest URL
- `EXPO_PUBLIC_WEBUI_MANIFEST_URL_PROD`: 운영 채널 최신 manifest URL
