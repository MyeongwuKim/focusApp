...
OAUTH_NATIVE_REDIRECT_SCHEMES=mobile,mobile-test
KAKAO_CLIENT_ID=
KAKAO_CLIENT_SECRET=
KAKAO_REDIRECT_URI=
...
NOTIFICATION_BATCH_INTERVAL_SECONDS=300
...
- `OAUTH_NATIVE_REDIRECT_SCHEMES`: 네이티브 앱 OAuth callback에 허용할 URL 스킴 목록
